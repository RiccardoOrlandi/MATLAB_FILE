...
/** Matrix of size: 51 x 21 (row major format)
 * 
 ...
 * 
 *  Matrix containing 50 reference/measurement vectors of size 7 for first 50 nodes.
 */
real_t y[ 350 ];
...
/** Matrix of size: 50 x 7 (row major format) */
real_t R2[ 350 ];
...
/** Matrix of size: 800 x 3 (row major format) */
real_t evHx[ 2400 ];
...
/** Matrix of size: 900 x 50 (row major format) */
real_t A[ 45000 ];
