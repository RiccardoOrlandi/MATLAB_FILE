...
% Formulazione ORIGINALE: griglia uniforme Ts=1s, N=50, nessuna slack.
%==========================================================================
% Script da eseguire dopo ACADO_3veh.m e prima della simulazione Simulink.
%==========================================================================

%% ========================================================================
%%  1. Soft Constraints / Cost Function Weights
%%  ========================================================================
% Ordine dei termini h in ACADO_3veh.m:
...
Qx1 = [ ...
    ...
    3, 3, 3, ...          %% jerk
    1.5, 1.5, 1.5, ...    %% longitudinal acceleration
    10, 10, 10, ...       %% stop target attraction
    20, 20, 20, ...    %% dwell position
    5, 5, 5, ...    %% dwell velocity
    1, 1, 1, ...    %% dwell acceleration
    0.5, 0.5];        %% spacing/aero 1-2 and 2-3
...
N_iter = 1;
Ts     = 1.0;   % [s] passo griglia uniforme = sample time controller
N      = 44;    % [-] numero intervalli OCP (orizzonte 50 s)
...
xInit = [0 0 0 -15 0 0 -30 0 0];
uInit = [0 0 0];   % 3 controlli: jerk1, jerk2, jerk3 (nessuna slack)
