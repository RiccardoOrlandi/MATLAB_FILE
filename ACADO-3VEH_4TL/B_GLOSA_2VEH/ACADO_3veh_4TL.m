...
s_TL = [45.5, 203.2, 384.2, 589.4, 773.6, 1004.2, 1225.3, 1419.7, 1507.8, 1739.0, 1823.0]; %#ok<NASGU>
...
gap_on    = 10;      % distanza oltre cui il costo si spegne [m]
sigma_gap = 0.01;    % morbidezza transizione [m]
