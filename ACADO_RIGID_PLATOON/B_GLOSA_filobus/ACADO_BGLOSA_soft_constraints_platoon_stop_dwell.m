...
cost_vmax = is(s_Vmax)/V_max; %5.velocità
cost_Ay = is(s_Ay)/Ay_max; %6.accelerazione laterale
%====================================
...
% COST FUNCTION
%==========================================
h = {cost_dist; cost_jerk; cost_Ax; cost_vmax; cost_Ay; cost_stop_target; cost_dwell_pos; cost_dwell_vel; cost_dwell_acc};
hN = {cost_dist};
...
ocp.subjectTo(is(vel*vel*k_road - Ay_max - s_Ay) <= 0);
