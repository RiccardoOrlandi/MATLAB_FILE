...
% 5  cost_vmax          slack velocità massima
% 6  cost_Ay            slack accelerazione laterale
% 9  cost_stop_target   attrazione verso fermata attiva
% 10 cost_dwell_pos     mantenimento posizione durante dwell
% 11 cost_dwell_vel     velocità nulla durante dwell
% 12 cost_dwell_acc     accelerazione nulla durante dwell

Qx1 = [10,2,0.5,10000,10000,50,200, 500, 100];
W1 = diag(Qx1);
NMPC_Wmat1 = [W1(1,:) W1(2,:) W1(3,:) W1(4,:) W1(5,:) W1(6,:) W1(7,:) W1(8,:) W1(9,:)];
