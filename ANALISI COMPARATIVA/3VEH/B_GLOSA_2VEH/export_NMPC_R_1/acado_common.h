...
/** Matrix of size: 51 x 63 (row major format)
 * 
 *  Matrix containing 51 online data vectors.
 */
real_t od[ 3213 ];

/** Column vector of size: 1150
 * 
 *  Matrix containing 50 reference/measurement vectors of size 23 for first 50 nodes.
 */
real_t y[ 1150 ];
...
/** Matrix of size: 450 x 23 (row major format) */
real_t Q2[ 10350 ];

/** Matrix of size: 150 x 3 (row major format) */
real_t R1[ 450 ];

/** Matrix of size: 150 x 23 (row major format) */
real_t R2[ 3450 ];
...
/** Column vector of size: 2500 */
real_t evH[ 2500 ];

/** Matrix of size: 2500 x 9 (row major format) */
real_t evHx[ 22500 ];

/** Matrix of size: 2500 x 3 (row major format) */
real_t evHu[ 7500 ];
...
/** Matrix of size: 2800 x 150 (row major format) */
real_t A[ 420000 ];
