...
% - riallineare la vecchia formulazione single-vehicle alla versione
%   B-GLOSA 3 veicoli indipendenti con 4 semafori attivi;
% - mantenere un solo veicolo modellato come corpo rigido di lunghezza
%   L_platoon, con vincoli semaforici applicati sia alla testa sia alla coda;
% - ridurre OnlineData da 31 a 21 parametri per nodo:
%       4 flag TL testa,
%       1 fermata attiva,
%       k_road precomputata,
%       Vmax,
...
% - rimuovere le slack su velocita' e accelerazione laterale, coerentemente
...
% Per confrontare con 3 veicoli da 8 m e gap desiderato 3 m:
%   L_platoon = 3*8 + 2*3 = 30 m.
% Se si vuole replicare il vecchio setup single-vehicle, impostare qui il
% valore precedentemente usato.
L_platoon = 30;       % ingombro longitudinale rigido equivalente [m]
...
% k_road e' fornita da lookup/precomputazione esterna e passata come
% OnlineData. Si usa abs(k_road) in OnlineDataArray.
...
% Piccola tolleranza numerica coerente con la versione 3-vehicle.
v_eps = 0.01;
