...
Control jerk jerk2 jerk3 s_Jmin1 s_Jmin2 s_Jmin3; %s_Jmax1 s_Jmax2 s_Jmax3;
...
cost_Jmin3 = is(s_Jmin3)/abs(jerk_min);

% cost_Jmax1 = is(s_Jmax1)/jerk_max;
% cost_Jmax2 = is(s_Jmax2)/jerk_max;
% cost_Jmax3 = is(s_Jmax3)/jerk_max;
...
h = {cost_dist; cost_dist2; cost_dist3; ...
     ...
     cost_Jmin1; cost_Jmin2; cost_Jmin3};
     %cost_Jmax1; cost_Jmax2; cost_Jmax3};
...
% jerk >= jerk_min - s_Jmin
%---------------------------------
ocp.subjectTo(is(jerk  - jerk_min + s_Jmin1) >= 0);
ocp.subjectTo(is(jerk2 - jerk_min + s_Jmin2) >= 0);
ocp.subjectTo(is(jerk3 - jerk_min + s_Jmin3) >= 0);
ocp.subjectTo(s_Jmin1 >= 0);
ocp.subjectTo(s_Jmin2 >= 0);
ocp.subjectTo(s_Jmin3 >= 0);

sJmin_max = 1.0;   % [m/s^3] prova iniziale

ocp.subjectTo(s_Jmin1 <= sJmin_max);
ocp.subjectTo(s_Jmin2 <= sJmin_max);
ocp.subjectTo(s_Jmin3 <= sJmin_max);

% %---------------------------------
% % Vincoli slack jerk max
% % jerk <= jerk_max + s_Jmax
% %---------------------------------
% ocp.subjectTo(is(jerk  - jerk_max - s_Jmax1) <= 0);
% ocp.subjectTo(is(jerk2 - jerk_max - s_Jmax2) <= 0);
% ocp.subjectTo(is(jerk3 - jerk_max - s_Jmax3) <= 0);
% ocp.subjectTo(s_Jmax1 >= 0);
% ocp.subjectTo(s_Jmax2 >= 0);
% ocp.subjectTo(s_Jmax3 >= 0);
...
mpc.set('MAX_NUM_QP_ITERATIONS',       2000);   % limita iterazioni QP: bound sul tempo di esecuzione
