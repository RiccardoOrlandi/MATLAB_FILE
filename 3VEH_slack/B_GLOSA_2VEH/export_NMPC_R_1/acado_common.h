...
{
int dummy;
/** Matrix of size: 41 x 9 (row major format)
 * 
...
/** Matrix of size: 41 x 63 (row major format)
 * 
 *  Matrix containing 41 online data vectors.
 */
real_t od[ 2583 ];

/** Column vector of size: 1040
 * 
 *  Matrix containing 40 reference/measurement vectors of size 26 for first 40 nodes.
 */
real_t y[ 1040 ];
...
/** Row vector of size: 213 */
real_t rk_xxx[ 213 ];

/** Matrix of size: 4 x 144 (row major format) */
real_t rk_kkk[ 576 ];
...
/** Matrix of size: 360 x 9 (row major format) */
real_t evGx[ 3240 ];

/** Matrix of size: 360 x 6 (row major format) */
real_t evGu[ 2160 ];

/** Column vector of size: 244 */
real_t objAuxVar[ 244 ];

/** Row vector of size: 78 */
real_t objValueIn[ 78 ];

/** Row vector of size: 416 */
real_t objValueOut[ 416 ];

/** Matrix of size: 360 x 9 (row major format) */
real_t Q1[ 3240 ];

/** Matrix of size: 360 x 26 (row major format) */
real_t Q2[ 9360 ];

/** Matrix of size: 240 x 6 (row major format) */
real_t R1[ 1440 ];

/** Matrix of size: 240 x 26 (row major format) */
real_t R2[ 6240 ];
...
/** Column vector of size: 852 */
real_t conAuxVar[ 852 ];

/** Row vector of size: 78 */
real_t conValueIn[ 78 ];

/** Row vector of size: 848 */
real_t conValueOut[ 848 ];

/** Column vector of size: 2120 */
real_t evH[ 2120 ];

/** Matrix of size: 2120 x 9 (row major format) */
real_t evHx[ 19080 ];

/** Matrix of size: 2120 x 6 (row major format) */
real_t evHu[ 12720 ];

/** Column vector of size: 53 */
real_t evHxd[ 53 ];

/** Column vector of size: 369 */
real_t sbar[ 369 ];
...
/** Matrix of size: 7380 x 6 (row major format) */
real_t E[ 44280 ];
...
/** Matrix of size: 2360 x 240 (row major format) */
real_t A[ 566400 ];
