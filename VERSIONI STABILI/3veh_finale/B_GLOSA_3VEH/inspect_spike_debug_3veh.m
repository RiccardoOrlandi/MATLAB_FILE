function inspect_spike_debug_3veh(out, t_query, mode, veh_id)
%==========================================================================
...
%
% Uso:
%   inspect_spike_debug_3veh(out, 91, 'list', 1)
%   inspect_spike_debug_3veh(out, [80 100], 'range', 1)
%   inspect_spike_debug_3veh(out, [80 100], 'range', 2)
%   inspect_spike_debug_3veh(out, [80 100], 'range', 3)
%
% veh_id:
%   1 -> out.debug_TL
%   2 -> out.debug_TL_2
