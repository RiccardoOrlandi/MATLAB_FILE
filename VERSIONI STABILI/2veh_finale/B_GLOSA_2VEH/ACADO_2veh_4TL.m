...
%
% Versione a 2 veicoli (ridotta dalla versione a 3 veicoli):
% - stati [pos, vel, acc, pos2, vel2, acc2];
% - controlli jerk, jerk2;
% - OnlineData a 42 elementi per nodo (21 dati per veicolo);
% - vincoli semaforici, fermate, velocita', accelerazione e jerk
%   replicati per i due veicoli;
% - vincolo e costo di spacing tra veicolo 1 e veicolo 2.
%=========================================================================
clc;
clear all;
close all;
...
%--------------------------------------------------------------------------
% 5.2 Costo spacing / beneficio aerodinamico tra i due veicoli
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% 7.3 Vincolo minimo sul gap tra i due veicoli
%--------------------------------------------------------------------------
