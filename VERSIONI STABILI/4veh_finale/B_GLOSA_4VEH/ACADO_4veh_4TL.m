...
% OnlineData per nodo: 84 = 21 dati per veicolo x 4 veicoli.
% Per ciascun veicolo:
...
L_platoon = 8;        % lunghezza veicolo / ingombro longitudinale [m]
...
% DISABLED_TEST ocp.subjectTo(acc4 <= Ax_max);
% DISABLED_TEST ocp.subjectTo(acc4 >= Ax_min);
...
% DISABLED_TEST ocp.subjectTo(jerk4 <= jerk_max);
% DISABLED_TEST ocp.subjectTo(jerk4 >= jerk_min);
...
% DISABLED_TEST ocp.subjectTo(is(vel4 * vel4 * k_road_4 - Ay_max) <= 0);
...
% DISABLED_TEST ocp.subjectTo(is(vel4 - Vmax_4) <= 0);

v_eps = 0.02;
ocp.subjectTo(vel  >= -v_eps);
ocp.subjectTo(vel2 >= -v_eps);
ocp.subjectTo(vel3 >= -v_eps);
% DISABLED_TEST ocp.subjectTo(vel4 >= -v_eps);
...
% DISABLED_TEST ocp.subjectTo(gap34 >= gap_min);
...
% DISABLED_TEST ocp.subjectTo(is(pos4 - ((s_stop_active_4 + eps_stop_num)*(1-x_stop_active_4) + s_max*x_stop_active_4)) <= 0);
...
% DISABLED_TEST ocp.subjectTo(is(pos4 - ((s_stop_active_4 + eps_stop_front)*x_dwell_active_4 + s_max*(1-x_dwell_active_4))) <= 0);
% DISABLED_TEST ocp.subjectTo(is((s_stop_active_4 - eps_stop_back)*x_dwell_active_4 - s_max*(1-x_dwell_active_4) - pos4) <= 0);
...
% DISABLED_TEST ocp.subjectTo(is(vel4 - (eps_stop_v*x_dwell_active_4 + V_max*(1-x_dwell_active_4))) <= 0);
% DISABLED_TEST ocp.subjectTo(is(acc4 - (eps_stop_a*x_dwell_active_4 + Ax_max*(1-x_dwell_active_4))) <= 0);
% DISABLED_TEST ocp.subjectTo(is(acc4 + (eps_stop_a*x_dwell_active_4 + abs(Ax_min)*(1-x_dwell_active_4))) >= 0);
...
% Testa veicolo 4
% DISABLED_TEST ocp.subjectTo(is(pos4 - ((s_TL1_active_4-d_safe_TL)*(1-x_TL1_4) + s_max*x_TL1_4)) <= 0);
% DISABLED_TEST ocp.subjectTo(is(pos4 - ((s_TL2_active_4-d_safe_TL)*(1-x_TL2_4) + s_max*x_TL2_4)) <= 0);
% DISABLED_TEST ocp.subjectTo(is(pos4 - ((s_TL3_active_4-d_safe_TL)*(1-x_TL3_4) + s_max*x_TL3_4)) <= 0);
% DISABLED_TEST ocp.subjectTo(is(pos4 - ((s_TL4_active_4-d_safe_TL)*(1-x_TL4_4) + s_max*x_TL4_4)) <= 0);

% Coda veicolo 4
% DISABLED_TEST ocp.subjectTo(is((pos4-L_platoon) - ((s_TL1_active_4-d_safe_TL)*(1-x_TL1_tail_4) + s_max*x_TL1_tail_4)) <= 0);
% DISABLED_TEST ocp.subjectTo(is((pos4-L_platoon) - ((s_TL2_active_4-d_safe_TL)*(1-x_TL2_tail_4) + s_max*x_TL2_tail_4)) <= 0);
% DISABLED_TEST ocp.subjectTo(is((pos4-L_platoon) - ((s_TL3_active_4-d_safe_TL)*(1-x_TL3_tail_4) + s_max*x_TL3_tail_4)) <= 0);
% DISABLED_TEST ocp.subjectTo(is((pos4-L_platoon) - ((s_TL4_active_4-d_safe_TL)*(1-x_TL4_tail_4) + s_max*x_TL4_tail_4)) <= 0);
