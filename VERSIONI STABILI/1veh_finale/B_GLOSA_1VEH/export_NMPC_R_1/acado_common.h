...
{
int dummy;
/** Matrix of size: 36 x 3 (row major format)
 * 
...
/** Matrix of size: 36 x 21 (row major format)
 * 
 *  Matrix containing 36 online data vectors.
 */
real_t od[ 756 ];

/** Column vector of size: 245
 * 
 *  Matrix containing 35 reference/measurement vectors of size 7 for first 35 nodes.
 */
real_t y[ 245 ];
...
/** Matrix of size: 105 x 7 (row major format) */
real_t Q2[ 735 ];

/** Column vector of size: 35 */
real_t R1[ 35 ];

/** Matrix of size: 35 x 7 (row major format) */
real_t R2[ 245 ];
...
/** Matrix of size: 630 x 35 (row major format) */
real_t A[ 22050 ];
