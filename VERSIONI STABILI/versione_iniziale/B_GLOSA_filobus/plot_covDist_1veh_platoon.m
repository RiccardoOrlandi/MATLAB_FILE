function h = plot_covDist_1veh_platoon(out, i_fig, s_TL, s_stop, L_platoon)
% ============================================================
% PLOT_COVDIST_1VEH_PLATOON
% Genera 3 figure:
...
xs   = out.states.signals.values;          % [1601 x 3]
...
%% ----------------------------------------------------------
%  2. ESTRAZIONE CONTROLLI (u = struct [1x1xN])
%  ----------------------------------------------------------
