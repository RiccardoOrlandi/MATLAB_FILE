...
/** Matrix of size: 3 x 8 (row major format) */
...
/** Matrix of size: 250 x 5 (row major format) */
real_t R1[ 1250 ];

/** Matrix of size: 250 x 8 (row major format) */
real_t R2[ 2000 ];
...
real_t conAuxVar[ 209 ];

/** Row vector of size: 33 */
real_t conValueIn[ 33 ];

/** Row vector of size: 207 */
real_t conValueOut[ 207 ];

/** Column vector of size: 1150 */
real_t evH[ 1150 ];

/** Matrix of size: 1150 x 3 (row major format) */
real_t evHx[ 3450 ];

/** Matrix of size: 1150 x 5 (row major format) */
real_t evHu[ 5750 ];
...
/** Matrix of size: 3825 x 5 (row major format) */
real_t E[ 19125 ];
...
/** Matrix of size: 250 x 250 (row major format) */
real_t H[ 62500 ];

/** Matrix of size: 1250 x 250 (row major format) */
real_t A[ 312500 ];
