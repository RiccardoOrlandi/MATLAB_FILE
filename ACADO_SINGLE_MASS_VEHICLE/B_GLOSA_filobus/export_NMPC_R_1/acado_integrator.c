...
acadoWorkspace.rk_xxx[12] = rk_eta[36];
acadoWorkspace.rk_xxx[13] = rk_eta[37];
acadoWorkspace.rk_xxx[14] = rk_eta[38];
acadoWorkspace.rk_xxx[15] = rk_eta[39];
acadoWorkspace.rk_xxx[16] = rk_eta[40];
acadoWorkspace.rk_xxx[17] = rk_eta[41];
acadoWorkspace.rk_xxx[18] = rk_eta[42];
acadoWorkspace.rk_xxx[19] = rk_eta[43];
acadoWorkspace.rk_xxx[20] = rk_eta[44];
acadoWorkspace.rk_xxx[21] = rk_eta[45];
acadoWorkspace.rk_xxx[22] = rk_eta[46];
acadoWorkspace.rk_xxx[23] = rk_eta[47];
acadoWorkspace.rk_xxx[24] = rk_eta[48];
acadoWorkspace.rk_xxx[25] = rk_eta[49];
acadoWorkspace.rk_xxx[26] = rk_eta[50];
acadoWorkspace.rk_xxx[27] = rk_eta[51];
acadoWorkspace.rk_xxx[28] = rk_eta[52];
acadoWorkspace.rk_xxx[29] = rk_eta[53];
acadoWorkspace.rk_xxx[30] = rk_eta[54];
acadoWorkspace.rk_xxx[31] = rk_eta[55];
acadoWorkspace.rk_xxx[32] = rk_eta[56];
...
acadoWorkspace.rk_diffsNew2[(i * 8) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)5.0000000000000003e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)5.0000000000000003e-02;
}
}
...
for (i = 0; i < 3; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 8) + (run1 + 3)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)5.0000000000000003e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)5.0000000000000003e-02;
}
}
