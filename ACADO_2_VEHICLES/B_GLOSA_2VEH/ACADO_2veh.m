%==========================================================================
% ACADO NMPC - B-GLOSA platoon 2 veicoli
%==========================================================================
...
%  ========================================================================
%  Questa sezione definisce tempo di campionamento, flag di export e
%  compilazione, stati differenziali, ingressi di controllo e OnlineData.
%  ========================================================================
Ts = 1;
EXPORT = 1;
COMPILE= 1;
...
% jerk  = jerk longitudinale veicolo 1
% jerk2 = jerk longitudinale veicolo 2
Control jerk jerk2;

% Dati aggiornati online lungo l'orizzonte di predizione.
% Convenzione:
% - x_TLi        : rilascio vincolo semaforico sulla testa del veicolo 1
% - x_TLi_tail   : rilascio vincolo semaforico sulla coda del veicolo 1
% - x_TLi_2      : rilascio vincolo semaforico sulla testa del veicolo 2
% - x_TLi_tail_2 : rilascio vincolo semaforico sulla coda del veicolo 2
...
%  ========================================================================
%  Parametri geometrici, limiti cinematici/dinamici e definizione del gap
%  tra i due veicoli.
%  ========================================================================
...
gap = pos - pos2 - L_platoon;       % gap desiderato per beneficio aerodinamico [m]

%Ax_max_mot = 1.15; %massima accelerazione motre [m/s^2]

%% ========================================================================
%  3. PARAMETRI FERMATE BUS E REGOLARIZZAZIONE VELOCITÀ
%  ========================================================================
%  Convenzione logica fermate:
...
%  ========================================================================
%  Modello cinematico longitudinale a jerk controllato per entrambi i
%  veicoli.
%  ========================================================================
...
%  ========================================================================
%  I termini sono normalizzati rispetto ai rispettivi valori di scala.
%  ========================================================================
...
gap_on = 10;      % distanza oltre cui l'effetto si spegne [m]
sigma_gap = 8;    % morbidezza della transizione [m]
aero_activation = 0.5 - atan((gap - gap_on)/sigma_gap)/pi;
cost_aero = is(aero_activation * (gap - d_gap)/d_gap);
...
%  ========================================================================
%  Costruzione dell'OCP ACADO, matrici di peso provvisorie per compilazione
%  e definizione dei termini LSQ.
%  ========================================================================
...
%--------------------------------------------------------------------------
% 7.2 Vincoli di velocità stradale e non-negatività velocità
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% 7.3 Vincolo minimo sul gap tra veicolo 1 e veicolo 2
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% 7.5 Vincoli semaforici sulla testa dei due veicoli
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
% 7.6 Vincoli semaforici sulla coda dei due veicoli
%--------------------------------------------------------------------------
...
%  ========================================================================
%  Impostazioni numeriche del solver e generazione interfaccia Simulink.
%  ========================================================================
