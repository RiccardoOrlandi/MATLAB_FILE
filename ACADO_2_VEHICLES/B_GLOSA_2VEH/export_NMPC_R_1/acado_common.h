...
/** Matrix of size: 51 x 62 (row major format)
 * 
 ...
 * 
 *  Matrix containing 50 reference/measurement vectors of size 15 for first 50 nodes.
 */
real_t y[ 750 ];
...
/** Matrix of size: 300 x 2 (row major format) */
real_t evGu[ 600 ];

/** Column vector of size: 95 */
real_t objAuxVar[ 95 ];

/** Row vector of size: 70 */
real_t objValueIn[ 70 ];
...
/** Matrix of size: 300 x 15 (row major format) */
real_t Q2[ 4500 ];

/** Matrix of size: 100 x 2 (row major format) */
real_t R1[ 200 ];

/** Matrix of size: 100 x 15 (row major format) */
real_t R2[ 1500 ];
...
/** Column vector of size: 552 */
real_t conAuxVar[ 552 ];

/** Row vector of size: 70 */
real_t conValueIn[ 70 ];

/** Row vector of size: 549 */
real_t conValueOut[ 549 ];

/** Column vector of size: 3050 */
real_t evH[ 3050 ];

/** Matrix of size: 3050 x 6 (row major format) */
real_t evHx[ 18300 ];

/** Matrix of size: 3050 x 2 (row major format) */
real_t evHu[ 6100 ];

/** Column vector of size: 61 */
real_t evHxd[ 61 ];
...
/** Matrix of size: 7650 x 2 (row major format) */
real_t E[ 15300 ];
...
/** Matrix of size: 3250 x 100 (row major format) */
real_t A[ 325000 ];
